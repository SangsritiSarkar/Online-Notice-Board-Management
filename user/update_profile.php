...
<h2 align="center"><B>UPDATE YOUR PROFILE</B></h2>
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					<td>Choose Your Year</td>
					<Td>
					<?php
					$arrr=explode(",",$res['hobbies']);
					?>
					1st<input value="1st" <?php if(in_array("1st",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					2nd<input value="2nd" <?php if(in_array("2nd",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					3rd<input value="3rd" <?php if(in_array("3rd",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					4th<input value="4th" <?php if(in_array("4th",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					</td>
				</tr>
