	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<Td>
					1st<input value="1st" type="checkbox" name="hob[]"/>
					2nd<input value="2nd" type="checkbox" name="hob[]"/>
					3rd<input value="3rd" type="checkbox" name="hob[]"/>
					4th<input value="4th" type="checkbox" name="hob[]"/>
					</td>
				</tr>
